...
(* OASIS_START *)
(* DO NOT EDIT (digest: f3d51c15d5fb12e60e9c7a1058b1bd04) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          bugreports = None;
          synopsis = "Read and format input.";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
          sections =
            [
               Library
                 ({
                     cs_name = "ocaml-read-and-format-input";
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "|.\217\1328\t\151\235t\240O\243\232s\253\204";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
